...
/**
 * <p>Java class for WsDeleteMemberResults complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WsDeleteMemberResults">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsDeleteMemberResult" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "WsDeleteMemberResults", propOrder = {
    "responseMetadata",
    "resultMetadata",
    "results",
...
public class WsDeleteMemberResults {
    ...
    protected List<WsDeleteMemberResult> results;
    @XmlElement(nillable = true)
     ...
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsDeleteMemberResult }
     * 
     * 
     */
    public List<WsDeleteMemberResult> getResults() {
        if (results == null) {
            results = new ArrayList<WsDeleteMemberResult>();
        }
        return this.results;
    }
