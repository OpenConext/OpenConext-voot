...
/**
 * <p>Java class for WsHasMemberLiteResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WsHasMemberLiteResult">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsHasMemberResult" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "WsHasMemberLiteResult", propOrder = {
    "responseMetadata",
    "resultMetadata",
    "results",
...
public class WsHasMemberLiteResult {
    ...
    protected List<WsHasMemberResult> results;
    @XmlElement(nillable = true)
     ...
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsHasMemberResult }
     * 
     * 
     */
    public List<WsHasMemberResult> getResults() {
        if (results == null) {
            results = new ArrayList<WsHasMemberResult>();
        }
        return this.results;
    }
