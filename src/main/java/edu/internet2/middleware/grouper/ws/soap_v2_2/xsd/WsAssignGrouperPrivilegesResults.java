...
/**
 * <p>Java class for WsAssignGrouperPrivilegesResults complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WsAssignGrouperPrivilegesResults">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsAssignGrouperPrivilegesResult" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "WsAssignGrouperPrivilegesResults", propOrder = {
    "responseMetadata",
    "resultMetadata",
    "results",
...
public class WsAssignGrouperPrivilegesResults {
    ...
    protected List<WsAssignGrouperPrivilegesResult> results;
    @XmlElement(nillable = true)
     ...
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsAssignGrouperPrivilegesResult }
     * 
     * 
     */
    public List<WsAssignGrouperPrivilegesResult> getResults() {
        if (results == null) {
            results = new ArrayList<WsAssignGrouperPrivilegesResult>();
        }
        return this.results;
    }
