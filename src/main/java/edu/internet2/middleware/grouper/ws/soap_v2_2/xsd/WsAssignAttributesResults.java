...
/**
 * <p>Java class for WsAssignAttributesResults complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WsAssignAttributesResults">
 *   &lt;complexContent>
 ...
 *         &lt;element name="wsAttributeAssignResults" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsAssignAttributeResult" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "WsAssignAttributesResults", propOrder = {
    "responseMetadata",
    "resultMetadata",
...
public class WsAssignAttributesResults {
    ...
    @XmlElement(nillable = true)
    protected List<WsAssignAttributeResult> wsAttributeAssignResults;
    @XmlElement(nillable = true)
    ...
    /**
     * Gets the value of the wsAttributeAssignResults property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the wsAttributeAssignResults property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWsAttributeAssignResults().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsAssignAttributeResult }
     * 
     * 
     */
    public List<WsAssignAttributeResult> getWsAttributeAssignResults() {
        if (wsAttributeAssignResults == null) {
            wsAttributeAssignResults = new ArrayList<WsAssignAttributeResult>();
        }
