...
/**
 * <p>Java class for WsAssignPermissionsResults complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WsAssignPermissionsResults">
 *   &lt;complexContent>
 ...
 *         &lt;element name="wsAssignPermissionResults" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsAssignPermissionResult" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "WsAssignPermissionsResults", propOrder = {
    "responseMetadata",
    "resultMetadata",
...
public class WsAssignPermissionsResults {
    ...
    @XmlElement(nillable = true)
    protected List<WsAssignPermissionResult> wsAssignPermissionResults;
    @XmlElement(nillable = true)
    ...
    /**
     * Gets the value of the wsAssignPermissionResults property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the wsAssignPermissionResults property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWsAssignPermissionResults().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsAssignPermissionResult }
     * 
     * 
     */
    public List<WsAssignPermissionResult> getWsAssignPermissionResults() {
        if (wsAssignPermissionResults == null) {
            wsAssignPermissionResults = new ArrayList<WsAssignPermissionResult>();
        }
