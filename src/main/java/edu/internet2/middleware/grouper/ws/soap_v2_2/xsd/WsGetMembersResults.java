...
/**
 * <p>Java class for WsGetMembersResults complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WsGetMembersResults">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsGetMembersResult" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "WsGetMembersResults", propOrder = {
    "responseMetadata",
    "resultMetadata",
    "results",
...
public class WsGetMembersResults {
    ...
    protected List<WsGetMembersResult> results;
    @XmlElement(nillable = true)
     ...
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsGetMembersResult }
     * 
     * 
     */
    public List<WsGetMembersResult> getResults() {
        if (results == null) {
            results = new ArrayList<WsGetMembersResult>();
        }
        return this.results;
    }
