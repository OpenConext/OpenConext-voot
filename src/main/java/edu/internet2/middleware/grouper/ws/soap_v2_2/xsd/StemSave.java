 ...
 *         &lt;element name="wsStemToSaves" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsStemToSave" maxOccurs="unbounded" minOccurs="0"/>
...
public class StemSave {
    ...
    protected List<WsStemToSave> wsStemToSaves;
    ...
    /**
     * Gets the value of the wsStemToSaves property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the wsStemToSaves property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWsStemToSaves().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemToSave }
     * 
     * 
     */
    public List<WsStemToSave> getWsStemToSaves() {
        if (wsStemToSaves == null) {
            wsStemToSaves = new ArrayList<WsStemToSave>();
        }
