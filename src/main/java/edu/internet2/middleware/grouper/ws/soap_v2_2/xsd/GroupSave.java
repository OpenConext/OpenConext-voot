 ...
 *         &lt;element name="wsGroupToSaves" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsGroupToSave" maxOccurs="unbounded" minOccurs="0"/>
...
public class GroupSave {
    ...
    protected List<WsGroupToSave> wsGroupToSaves;
    ...
    /**
     * Gets the value of the wsGroupToSaves property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the wsGroupToSaves property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWsGroupToSaves().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsGroupToSave }
     * 
     * 
     */
    public List<WsGroupToSave> getWsGroupToSaves() {
        if (wsGroupToSaves == null) {
            wsGroupToSaves = new ArrayList<WsGroupToSave>();
        }
