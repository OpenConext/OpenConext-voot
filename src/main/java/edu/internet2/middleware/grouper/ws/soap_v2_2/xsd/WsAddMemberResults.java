...
/**
 * <p>Java class for WsAddMemberResults complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WsAddMemberResults">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsAddMemberResult" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="subjectAttributeNames" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="wsGroupAssigned" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsGroup" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "WsAddMemberResults", propOrder = {
    "responseMetadata",
    "resultMetadata",
    "results",
...
public class WsAddMemberResults {
    ...
    protected List<WsAddMemberResult> results;
    @XmlElement(nillable = true)
    protected List<String> subjectAttributeNames;
    @XmlElementRef(name = "wsGroupAssigned", namespace = "http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<WsGroup> wsGroupAssigned;
     ...
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsAddMemberResult }
     * 
     * 
     */
    public List<WsAddMemberResult> getResults() {
        if (results == null) {
            results = new ArrayList<WsAddMemberResult>();
        }
        return this.results;
    }
    ...
    /**
     * Gets the value of the wsGroupAssigned property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<WsGroup> getWsGroupAssigned() {
        return wsGroupAssigned;
    }

    /**
     * Sets the value of the wsGroupAssigned property.
     * 
     * @param value
     *     allowed object is
     *     {@link javax.xml.bind.JAXBElement }{@code <}{@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsGroup }{@code >}
     *     
     */
    public void setWsGroupAssigned(JAXBElement<WsGroup> value) {
        this.wsGroupAssigned = value;
    }
