...
/**
 * <p>Java class for WsGroupSaveResults complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WsGroupSaveResults">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsGroupSaveResult" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "WsGroupSaveResults", propOrder = {
    "responseMetadata",
    "resultMetadata",
    "results"
})
public class WsGroupSaveResults {
    ...
    protected List<WsGroupSaveResult> results;
     ...
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsGroupSaveResult }
     * 
     * 
     */
    public List<WsGroupSaveResult> getResults() {
        if (results == null) {
            results = new ArrayList<WsGroupSaveResult>();
        }
        return this.results;
    }
