...
/**
 * <p>Java class for WsGetGroupsResults complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WsGetGroupsResults">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsGetGroupsResult" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "WsGetGroupsResults", propOrder = {
    "responseMetadata",
    "resultMetadata",
    "results",
...
public class WsGetGroupsResults {
    ...
    protected List<WsGetGroupsResult> results;
    @XmlElement(nillable = true)
     ...
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsGetGroupsResult }
     * 
     * 
     */
    public List<WsGetGroupsResult> getResults() {
        if (results == null) {
            results = new ArrayList<WsGetGroupsResult>();
        }
        return this.results;
    }
