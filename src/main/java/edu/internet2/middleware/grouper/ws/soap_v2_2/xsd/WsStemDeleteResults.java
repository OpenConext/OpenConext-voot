...
/**
 * <p>Java class for WsStemDeleteResults complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WsStemDeleteResults">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsStemDeleteResult" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "WsStemDeleteResults", propOrder = {
    "responseMetadata",
    "resultMetadata",
    "results"
})
public class WsStemDeleteResults {
    ...
    protected List<WsStemDeleteResult> results;
     ...
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsStemDeleteResult }
     * 
     * 
     */
    public List<WsStemDeleteResult> getResults() {
        if (results == null) {
            results = new ArrayList<WsStemDeleteResult>();
        }
        return this.results;
    }
