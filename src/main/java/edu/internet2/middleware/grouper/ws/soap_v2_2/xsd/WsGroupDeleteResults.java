...
/**
 * <p>Java class for WsGroupDeleteResults complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WsGroupDeleteResults">
 *   &lt;complexContent>
 ...
 *         &lt;element name="results" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsGroupDeleteResult" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "WsGroupDeleteResults", propOrder = {
    "responseMetadata",
    "resultMetadata",
    "results"
})
public class WsGroupDeleteResults {
    ...
    protected List<WsGroupDeleteResult> results;
     ...
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsGroupDeleteResult }
     * 
     * 
     */
    public List<WsGroupDeleteResult> getResults() {
        if (results == null) {
            results = new ArrayList<WsGroupDeleteResult>();
        }
        return this.results;
    }
