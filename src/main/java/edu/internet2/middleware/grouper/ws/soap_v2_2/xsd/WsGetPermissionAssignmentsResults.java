...
/**
 * <p>Java class for WsGetPermissionAssignmentsResults complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WsGetPermissionAssignmentsResults">
 *   &lt;complexContent>
 ...
 *         &lt;element name="wsPermissionAssigns" type="{http://soap_v2_0.ws.grouper.middleware.internet2.edu/xsd}WsPermissionAssign" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "WsGetPermissionAssignmentsResults", propOrder = {
    "responseMetadata",
    "resultMetadata",
...
public class WsGetPermissionAssignmentsResults {
    ...
    @XmlElement(nillable = true)
    protected List<WsPermissionAssign> wsPermissionAssigns;
    @XmlElement(nillable = true)
    ...
    /**
     * Gets the value of the wsPermissionAssigns property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the wsPermissionAssigns property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWsPermissionAssigns().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link edu.internet2.middleware.grouper.ws.soap_v2_2.xsd.WsPermissionAssign }
     * 
     * 
     */
    public List<WsPermissionAssign> getWsPermissionAssigns() {
        if (wsPermissionAssigns == null) {
            wsPermissionAssigns = new ArrayList<WsPermissionAssign>();
        }
